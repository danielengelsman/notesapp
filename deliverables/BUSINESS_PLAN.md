...
- **Proof before payment**: the free tier parses everything and shows a trial-balance reconciliation report — penny-level agreement with QuickBooks' own numbers — before any money changes hands. The engine is built and tested: 26 automated tests, penny-perfect reconciliation on a 6-year, 1,369-transaction fixture company, and detection of sabotaged or filtered exports.
